...
```
**s_0**: Stock price at time ![equation](http://latex.codecogs.com/gif.latex?t_0%3D%5Ctext%20%7B%20Onset%20event%20at%20time%20bin%20%7D%20t)  (Current price of stock). 
<br />
**u**: Up factor <br />
**d**: Down factor <br />
